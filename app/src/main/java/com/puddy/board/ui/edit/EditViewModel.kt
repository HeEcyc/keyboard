package com.puddy.board.ui.edit
...
import com.puddy.board.databinding.ItemBgBinding
...
import com.puddy.board.ui.home.HomeViewModel
...
class EditViewModel(
    ...
    val adapterFonts = createAdapter<KeyboardFont, com.puddy.board.databinding.ItemFontBinding>(R.layout.item_font) {
    ...
    fun attachKeyboard(keyboardTheme: KeyboardTheme) {
        ...
        homeViewModel.adapterCustom.addItem(1, keyboardTheme)
