...
import com.smard.boart.databinding.ItemBgBinding
...
class EditViewModel(
    ...
    val adapterFonts = createAdapter<KeyboardFont, com.smard.boart.databinding.ItemFontBinding>(R.layout.item_font) {
