package com.smard.boart.repository
...
import com.smard.boart.ime.core.SubtypeManager
...
object PrefsReporitory {
    ...
    private val sharedPreferences by lazy { App.instance.getSharedPreferences("prefs", MODE_PRIVATE) }
